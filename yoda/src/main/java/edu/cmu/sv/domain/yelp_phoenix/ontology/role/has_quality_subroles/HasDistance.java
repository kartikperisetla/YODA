...
import edu.cmu.sv.domain.yelp_phoenix.ontology.preposition.DistancePreposition;
 ...
 */
public class HasDistance extends HasQualityRole {
    static Set<Class <? extends ThingWithRoles>> domain = new HashSet<>(Arrays.asList(PointOfInterest.class));
    static Set<Class <? extends Thing>> range = new HashSet<>(Arrays.asList(DistancePreposition.class));

 ...
 */
public class OOCRespondToRequestListOptions extends DialogAct {
    ...
    public Double reward(DialogState dialogState, DiscourseUnit discourseUnit){
        return RewardAndCostCalculator.rewardForOOCRespondToRequestListOptions(dialogState, discourseUnit);
    }

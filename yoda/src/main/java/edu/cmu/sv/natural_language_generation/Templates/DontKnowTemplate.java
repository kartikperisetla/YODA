 ...
 */
public class DontKnowTemplate implements Template {
    @Override
    public Map<String, JSONObject> generateAll(JSONObject constraints, YodaEnvironment yodaEnvironment, int remainingDepth) {
        // ensure that the constraints match this template
        try {
            Assert.verify(constraints.get("dialogAct").equals(DontKnow.class.getSimpleName()));
        ...
        ans.put("I don't know", SemanticsModel.parseJSON(constraints.toJSONString()));
        return ans;
    }
}

 ...
 */
public class NounPhraseMultiInterpreter implements MiniMultiLanguageInterpreter{
    ...
    public NounPhraseMultiInterpreter(YodaEnvironment yodaEnvironment) {
...
//                    adjectiveStringSetMap.put(adjectiveClass, regexString);
    ...
    public NBestDistribution<JSONObject> interpret(List<String> tokens, YodaEnvironment yodaEnvironment) {
        ...
        ans.put(entity1JSON, RegexPlusKeywordUnderstander.nounPhraseInterpreterWeight);
        return ans;
    }

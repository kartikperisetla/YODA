        ...
        for (Map.Entry<String, SemanticsModel> utteranceMeaningPair : corpus) {
            ...
            for (String slotPath : Iterables.concat(utteranceMeaning.getAllInternalNodePaths(), Arrays.asList(""))) {
                ...
                if (groundTruthContent.containsKey("class") &&
                        OntologyRegistry.adjectiveClasses.contains(
                                OntologyRegistry.thingNameMap.get(groundTruthContent.get("class"))))
                    continue;
                ...
                for (Object key : groundTruthContent.keySet()) {
                    ...
                    else if (OntologyRegistry.thingNameMap.containsKey(key) &&
                            HasQualityRole.class.isAssignableFrom(OntologyRegistry.thingNameMap.get(key))) {
